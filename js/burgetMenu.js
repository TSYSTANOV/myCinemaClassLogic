...
class Menu{
    ...
    addListener(HTMLelement){
        HTMLelement.addEventListener('click',()=>{
            ...
            if(event.target.tagName !== 'A' && !event.target.closest('.navigation__close')){
                return
            }
    ...
    openMenu(){
        document.querySelector(this.MENU_elementClass).classList.add('navigation_active')
    }
    closeMenu(){
        if(document.querySelector(this.MENU_elementClass)){
        document.querySelector(this.MENU_elementClass).classList.remove('navigation_active')
        }
    }
}
